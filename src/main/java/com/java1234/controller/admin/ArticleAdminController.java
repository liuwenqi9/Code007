...
public class ArticleAdminController {
	...
	public ModelAndView update(Article article)throws Exception{
		...
		oldArticle.setDownload2(article.getDownload2());
		oldArticle.setPassword2(article.getPassword2());
	...
	public Map<String,Object> deleteSelected(String ids)throws Exception{
		...
		for(int i=0;i<idsStr.length;i++){
			...
			redisUtil.del("article_"+idsStr[i],"hotArticleList_type_"+articleService.get(Integer.parseInt(idsStr[i])).getArcType().getId());
		}
